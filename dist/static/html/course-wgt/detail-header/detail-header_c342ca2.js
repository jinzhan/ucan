define('modules/html/course-wgt/detail-header/detail-header', function(require, exports, module) {
  ...
  var Dialog = require('modules/lib/jquery.ui.dialog');
  var juicer = require('modules/lib/juicer');
